...
%---------------------------------------------------------
  \cventry
    ...
    {Austria, Belgium, Czechia, Germany and  Spain} % Location
    {2015--2019} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        ...
        \item {Responsible for presenting concepts and solutions to the partners, writing and reviewing project \hrefs{https://electrific-project.eu/project-deliverables/}{deliverables.}}
